 ...
 * 
 * DO NOT USE : FOR ARCHIVE PURPOSES ONLY!
 * 
 * @author maclean
 *
 */
public class SignatureFailedImplementation {
    ...
    public SignatureFailedImplementation(int atomNumber, IMolecule molecule) {
        this(molecule.getAtom(atomNumber), molecule);
    }
    
    public SignatureFailedImplementation(IAtom atom, IMolecule molecule) {
    ...
    public static SignatureFailedImplementation forMolecule(IMolecule molecule) {
        SignatureFailedImplementation[] atomSignatures = new SignatureFailedImplementation[molecule.getAtomCount()];
        int i = 0;
        for (IAtom atom : molecule.atoms()) {
            atomSignatures[i] = new SignatureFailedImplementation(atom, molecule);
            i++;
        }
